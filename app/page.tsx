...
export default async function Home() {
  ...
  // console.log("Check session info!");
    ...
    <main className="flex min-h-screen flex-col p-6">
      ...
      <div className="flex flex-col grow gap-6 shrink-0 justify-center text-center rounded-lg bg-gray-50 p-4 md:h-52">
        <p className={`text-xl text-gray-800 md:text-3xl md:leading-normal`}>
          <strong>Welcome {session?.user?.name} to Energy  Tracker.</strong> Energy Tracker is an app that will monitor the wellbeing of individuals.
        </p>
      </div>
